                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        >
                            <motion.div
                                ...
                                whileTap={{ scale: 0.98 }}
                            >
                                <Button size="lg" variant="secondary" className="bg-secondary text-secondary-foreground hover:bg-secondary/90 px-8" asChild>
                                    <a href="#contact">
                    ...
                    <div className="grid md:grid-cols-4 gap-12">
                        ...
                        >
                            ...
                            <div className="flex gap-3">
                                {[
                                    { icon: Instagram, label: "Instagram", href: "https://instagram.com/madre_cafe" },
                                    { icon: Facebook, label: "Facebook", href: "https://facebook.com/madrecafe" }
                                ].map((social, index) => (
                                    <motion.div
                                        key={index}
